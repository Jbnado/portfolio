...
export const FISH: Fish[] = [
  ...
  { id: 'p2', tier: 1, weight: 10, color: 'var(--fishing-fish-b)', sizeMin: 18, sizeMax: 46,
    engine: 'hold',
    params: { bandHeight: 0.34, gravity: 0.000003, lift: 0.000008, maxSpeed: 0.0007, pattern: 'calmo', fishSpeed: 0.00020, fillRate: 0.0006, drainRate: 0.0003, graceMs: 2500 } },
  ...
  { id: 'p5', tier: 2, weight: 1, color: 'var(--fishing-fish-e)', sizeMin: 10, sizeMax: 28,
    engine: 'hold',
    params: { bandHeight: 0.19, gravity: 0.0000035, lift: 0.000009, maxSpeed: 0.0009, pattern: 'erratico', fishSpeed: 0.00050, fillRate: 0.00054, drainRate: 0.00045, graceMs: 1600 } },
  ...
  { id: 'p8', tier: 3, weight: 1, color: 'var(--fishing-fish-h)', sizeMin: 40, sizeMax: 95,
    engine: 'hold',
    params: { bandHeight: 0.15, gravity: 0.0000045, lift: 0.000011, maxSpeed: 0.0012, pattern: 'arisco', fishSpeed: 0.00060, fillRate: 0.00052, drainRate: 0.00048, graceMs: 1400 } },
