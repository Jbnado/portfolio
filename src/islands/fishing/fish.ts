...
export const FISH: Fish[] = [
  ...
  { id: 'p8', tier: 3, weight: 1, color: 'var(--fishing-fish-h)', sizeMin: 40, sizeMax: 95,
    engine: 'hold',
    params: { bandHeight: 0.20, gravity: 0.0000045, lift: 0.000011, maxSpeed: 0.0012, pattern: 'arisco', fishSpeed: 0.00060, fillRate: 0.00036, drainRate: 0.00024, graceMs: 1400 } },
