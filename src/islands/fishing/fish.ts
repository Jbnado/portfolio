...
export const FISH: Fish[] = [
  ...
  { id: 'p1', tier: 1, weight: 45, water: 'doce', color: 'var(--fishing-fish-a)', sizeMin: 8, sizeMax: 18,
    engine: 'track',
    params: { periodMs: 2600, zoneSize: 0.30, hits: 3, tolerance: 2 } },
  { id: 'p2', tier: 1, weight: 10, water: 'doce', color: 'var(--fishing-fish-b)', sizeMin: 25, sizeMax: 55,
    engine: 'hold',
  ...
  { id: 'p3', tier: 1, weight: 45, water: 'salgada', color: 'var(--fishing-fish-c)', sizeMin: 25, sizeMax: 50,
    engine: 'dodge',
  ...
  { id: 'p4', tier: 2, weight: 45, water: 'salgada', color: 'var(--fishing-fish-d)', sizeMin: 30, sizeMax: 70,
    engine: 'track',
    params: { periodMs: 2400, zoneSize: 0.25, hits: 3, tolerance: 2 } },
  { id: 'p5', tier: 2, weight: 10, water: 'doce', color: 'var(--fishing-fish-e)', sizeMin: 28, sizeMax: 58,
    engine: 'hold',
  ...
  { id: 'p6', tier: 2, weight: 45, water: 'doce', color: 'var(--fishing-fish-f)', sizeMin: 35, sizeMax: 80,
    engine: 'dodge',
    params: { periodMs: 2600, gatesMin: 4, gatesMax: 5, gapMin: 0.07, gapMax: 0.11,
      holdMs: 4000, penaltyMs: 2000, fallsToLose: 3, zeroesToLose: 2 } },

  // ---- Faixa 3, o abissal. Sem perdao.
  { id: 'p7', tier: 3, weight: 45, water: 'salgada', color: 'var(--fishing-fish-g)', sizeMin: 45, sizeMax: 95,
    engine: 'track',
    params: { periodMs: 2200, zoneSize: 0.15, hits: 3, tolerance: 2 } },
  { id: 'p8', tier: 3, weight: 10, water: 'doce', color: 'var(--fishing-fish-h)', sizeMin: 55, sizeMax: 105,
    engine: 'hold',
  ...
  { id: 'p9', tier: 3, weight: 45, water: 'doce', color: 'var(--fishing-fish-i)', sizeMin: 80, sizeMax: 150,
    engine: 'dodge',
    params: { periodMs: 1900, gatesMin: 4, gatesMax: 6, gapMin: 0.06, gapMax: 0.10,
      holdMs: 5000, penaltyMs: 2500, fallsToLose: 3, zeroesToLose: 2 } },
];
