...
export const FISH: Fish[] = [
  ...
  { id: 'p4', tier: 2, weight: 1, color: 'var(--fishing-fish-d)', sizeMin: 15, sizeMax: 40,
    engine: 'track',
    params: { path: 'radial', periodMs: 1650, zones: [{ pos: 0.35, size: 0.11 }], hits: 2, alternates: false, tolerance: 2 } },
  ...
  { id: 'p7', tier: 3, weight: 1, color: 'var(--fishing-fish-g)', sizeMin: 26, sizeMax: 65,
    engine: 'track',
    params: { path: 'pendulo', periodMs: 1650, zones: [{ pos: 0.2, size: 0.15 }, { pos: 0.8, size: 0.15 }], hits: 3, alternates: true, tolerance: 2 } },
